  ...
  return (
    <section className='relative h-[80vh] max-md:h-[1350px] max-3xl:mt-[100px]'>
      <div className='absolute top-[0] max-md:top-0 w-full h-[500px]'>
        ...
        <div className='flex justify-evenly max-md:flex-col max-xl:gap-7 gap-3 mt-[30px] max-md:w-[70%] max-md:mx-auto '>
          ...
          <div className='h-[350px] w-full  rounded-lg text-center'>
            ...
            <h4 className=' text-2xl text-zinc-300 leading-[1.5] mt-[10px] mx-[50px] max-xl:mx-[10px] max-sm:text-xl'>We pride ourselves in ensuring that all of our students pass with flying colours!</h4>
          </div>
          ...
          <div className='h-[350px] w-full  rounded-lg text-center '>
            ...
            <h4 className=' text-2xl text-zinc-300 leading-[1.5] mt-[5px] mx-[50px] max-xl:mx-[10px] max-sm:text-xl'>All of our instructors have been tested to ensure that they teach our students effectively.</h4>
          </div>
          ...
          <div className='h-[350px] w-full  rounded-lg text-center'>
            ...
            <h4 className=' text-2xl text-zinc-300 leading-[1.5] mt-[10px] mx-[50px] max-xl:mx-[10px] max-sm:text-xl'>Instructors measure progress of our students so we can teach them the skills to succeed.</h4>
          </div>
