...
const About = () => {
  return (
    <section className='relative h-[80vh] max-md:h-[1350px]'>
      <div className='absolute top-[0] max-md:top-0 w-full h-[500px]'>
        ...
        <div className='flex justify-evenly max-md:flex-col max-xl:gap-7 gap-3 mt-[30px]  '>
          ...
          <div className='h-[350px] w-full   rounded-lg text-center'>
            <AcademicCapIcon className="h-[100px] text-orange-500 w-[100px] drop-shadow-[0_0px_10px_rgba(255,165,0,0.5)] shadow-rose-500 mx-auto mt-[20px]" />
          ...
          <div className='h-[350px] w-full  rounded-lg text-center '>
            ...
            <h4 className=' text-2xl text-zinc-300 leading-[1.5] mt-[5px] mx-[50px] max-xl:mx-[10px] '>We pride ourselves in ensuring that all of our students pass with flying colours.</h4>
          </div>
