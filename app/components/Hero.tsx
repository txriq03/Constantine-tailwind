...
const Hero = () => {
  return (
    <section className='h-[90vh] mt-20 max-3xl:mt-5 '>
        ...
        <Image className=' z-[10] object-contain w-70 h-auto absolute top-[15rem] -right-[20rem] max-2xl:-right-[30rem] max-xl:left-[75%] max-lg:hidden 3xl:left-[60%] 3xl:top-[16rem] 3xl:w-[1200px]' alt='car' priority src={sideview} height={1000} width={1000} />
